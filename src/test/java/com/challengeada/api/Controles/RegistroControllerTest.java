...
public class RegistroControllerTest {
	...
	public void testCadastrarLancamento() throws Exception {
		Registro registro = obterDadosLancamento();
	...
	public void testRemoverLancamento() throws Exception {
		BDDMockito.given(this.registroService.buscarPorId(Mockito.anyLong())).willReturn(Optional.of(new Registro()));
