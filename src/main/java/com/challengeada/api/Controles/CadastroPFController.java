...
import com.challengeada.api.Dtos.CadastroPFDto;
...
public class CadastroPFController {
	...
	@PostMapping
	public ResponseEntity<Resposta<CadastroPFDto>> cadastrar(@Valid @RequestBody CadastroPFDto cadastroPFDto,
															 BindingResult result) throws NoSuchAlgorithmException {
		log.info("Cadastrando PF: {}", cadastroPFDto.toString());
		Resposta<CadastroPFDto> resposta = new Resposta<CadastroPFDto>();
		...
		resposta.setData(this.converterCadastroPFDto(funcionario));
