...
import com.challengeada.api.Dtos.FuncionarioDto;
...
public class FuncionarioController {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Resposta<FuncionarioDto>> atualizar(@PathVariable("id") Long id,
															  @Valid @RequestBody FuncionarioDto funcionarioDto, BindingResult result) throws NoSuchAlgorithmException {
		log.info("Atualizando funcionário: {}", funcionarioDto.toString());
		Resposta<FuncionarioDto> resposta = new Resposta<FuncionarioDto>();
		...
		resposta.setData(this.converterFuncionarioDto(funcionario.get()));
